  ...
  render() {
    ...
    return (
      <Router>
        ...
        <Route path="/voirclient/:id" component={() => vrfLogged?<Voirclient loggedIn={this.state.vrfLogged} idUserRecup={this.state.vrfIdUser} infoTypeCompte={this.state.vrfInfosTypeCompte} /> : <Redirect to="/" />} />
